...
export default function About() {
  const skillDescriptions = {
    ...
    VUE: '진행형 UI 구축을 위한 반응형 JavaScript 프레임워크입니다.',
    GIT: '버전 관리를 위한 분산형 소스 코드 관리 도구입니다.',
    SASS: 'CSS 전처리기로 더 효율적인 스타일 작성이 가능합니다.',
    W3C: '웹 표준을 정의하고 권장하는 국제 웹 표준화 기구입니다.',
    WAI: '웹 접근성을 위한 가이드라인과 표준을 제시하는 이니셔티브입니다.',
    RWD: '다양한 화면 크기에 유연하게 대응하는 반응형 웹 디자인 기법입니다.',
  };
  ...
  const toolDescriptions = {
    ...
    MONGODB: '비관계형(NoSQL) 문서 지향 데이터베이스 관리 시스템입니다.',
    CHATGPT: '자연어 이해와 생성이 가능한 인공지능 언어 모델 서비스입니다.',
  };
